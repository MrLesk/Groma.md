...
`groma scan --watch` repeats the same complete scan after supported TypeScript or C# source and project changes settle. `groma view` and `groma web` use that watch in-process.
