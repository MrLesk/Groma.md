...
the current repository: Up and Down choose an action and Enter runs it. Without
an interactive terminal, it prints the same context and actions as plain text.
