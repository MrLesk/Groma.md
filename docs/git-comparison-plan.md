...
Alex. Implementation choices are recommendations for review. Implementation of this plan was approved by Alex and is tracked in TASK-447.

The separately requested removal of the direct Open PR integration is tracked
in TASK-445. TASK-447 implements comparison and the optional GitHub revision source below.
The final behavior and module ownership are documented in
[Review Git changes](viewers/web/git-comparison.md).
...
The old direct GitHub implementation was removed in TASK-445. Do not restore it or add compatibility adapters, legacy URL handling, or migrations.
