...
The implemented surface includes initialization, project registration, canonical component
operations, and bounded blueprint export/search/traversal. The public `scan`, reconciliation, and
visual experience are not implemented yet; help and bare overview must remain honest about that.
