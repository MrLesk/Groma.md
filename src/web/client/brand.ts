/* Canonical brand markup; keep byte-identical to brand/lockup.svg and brand/mark-frontal.svg. */

export const GROMA_LOCKUP = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 440 120" role="img" aria-label="groma.md lockup">
...
export const MARK_FRONTAL = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" role="img" aria-label="Groma mark, frontal">
  <circle cx="50" cy="6" r="5" fill="currentColor"/>
  <line x1="50" y1="12" x2="50" y2="94" stroke="currentColor" stroke-width="7" stroke-linecap="round"/>
  <line x1="22" y1="32" x2="78" y2="32" stroke="currentColor" stroke-width="7" stroke-linecap="round"/>
  <line x1="22" y1="36" x2="22" y2="62" stroke="currentColor" stroke-width="4"/>
