...
// Vue script and in a TypeScript file compares equal; change both together.
...
/** The type positions the reference skips, so annotations do not change a body. */
function skipType(node: ts.Node): boolean {
