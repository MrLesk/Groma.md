...
internal static class ProjectInput
{
    ...
    private static void ValidateProjectFile(string root, string project)
    {
        ...
        if (sdk is not ("Microsoft.NET.Sdk" or "Microsoft.NET.Sdk.Web" or "Microsoft.NET.Sdk.Worker"))
            throw new InvalidDataException($"Unsupported project SDK in '{SourcePath.Relative(root, project)}'. Supported project headers are Microsoft.NET.Sdk, Microsoft.NET.Sdk.Web and Microsoft.NET.Sdk.Worker.");
    }
