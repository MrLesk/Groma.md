...
Turn the desired first-run experience into an evidence-based quality gate using Groma and a held-out TypeScript or Bun project, without requiring automatic output to reproduce curated domain names or prose.
...
- [ ] #6 At least one held-out TypeScript or Bun fixture is reserved from scanner-specific tuning and the documented groma init, groma scan, groma friend workflow is included in the evaluation
<!-- AC:END -->
