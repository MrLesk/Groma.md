...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Scanner installation fixtures create archives on Windows and Unix without interpreting a drive letter as a remote archive host.
- [ ] #2 The Backlog shutdown test distinguishes a running process from an exited unreaped process and still detects a surviving worker or unrelated subscription being stopped.
- [ ] #3 The complete repository check passes locally and the pushed CI run passes Ubuntu, macOS and Windows.
<!-- AC:END -->
